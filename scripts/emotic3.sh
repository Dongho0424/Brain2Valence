...
CUDA_VISIBLE_DEVICES=${device} python3 main.py --exec_mode train --all-subjects \
 --wandb-log --wandb-name 0321adamw_SL1 --model-name 0321adamw_SL1 --wandb-project Emotic --wandb-entity donghochoi \
 --model resnet18 --data brain3d --epochs 50 --batch-size 26 --lr 1e-4 --weight-decay 1e-2 --optimizer adamw --scheduler cosine --criterion emotic_SL1 \
