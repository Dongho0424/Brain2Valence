        ...
        do
            ...
            do
                if [ "$subj" == "$all_subjects" ]; then
                    model_name="emo_roi_pretrained_lr_${lr}_subj_1257_pn_${pn}_exclude_least_st${st}"
                else
                    model_name="emo_roi_pretrained_lr_${lr}_subj_${subj}_pn_${pn}_exclude_least_st${st}"
                fi
