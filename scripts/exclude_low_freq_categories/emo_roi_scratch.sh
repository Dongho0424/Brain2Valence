...
DONGHO=" --wandb-project v2_w.o_low_categories --wandb-entity donghochoi --wandb-log --dataset-ver 2 --optimizer adamw --scheduler cosine --criterion emotic_SL1 --cat-criterion ${cat_loss}"
...
#                     model_name="emo_roi_scratch_lr_${lr}_subj_1257_pn_${pn}_exclude_low_st${st}"
#                 else
#                     model_name="emo_roi_scratch_lr_${lr}_subj_${subj}_pn_${pn}_exclude_low_st${st}"
#                 fi
...
do
    ...
    do
        ...
        do
            ...
            do
                if [ "$subj" == "$all_subjects" ]; then
                    model_name="emo_roi_scratch_lr_${lr}_subj_1257_pn_${pn}_exclude_low_st${st}_"
                else
                    model_name="emo_roi_scratch_lr_${lr}_subj_${subj}_pn_${pn}_exclude_low_st${st}_"
                fi
