...
#                     model_name="vis_roi_pretrained_lr_${lr}_subj_1257_pn_${pn}_exclude_low_st${st}"
#                 else
#                     model_name="vis_roi_pretrained_lr_${lr}_subj_${subj}_pn_${pn}_exclude_low_st${st}"
#                 fi
...
do
    ...
    do
        ...
        do
            ...
            do
                if [ "$subj" == "$all_subjects" ]; then
                    model_name="vis_roi_pretrained_lr_${lr}_subj_1257_pn_${pn}_exclude_low_st${st}_"
                else
                    model_name="vis_roi_pretrained_lr_${lr}_subj_${subj}_pn_${pn}_exclude_low_st${st}_"
                fi
