...
do
    model_name="img_only_default_frz_lr_${lr}"
    group="img_only_default_frz"
    note="250116_1"
    ...
    --task-type emotic --pretrained default --image-backbone resnet18 --model-type ${model_type} --data brain3d --with-nsd --cat-only --backbone-freeze \
    --wandb-log
