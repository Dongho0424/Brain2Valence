...
DONGHO="--wandb-entity donghochoi --wandb-log --wandb-project pretrained_dataset_v2 --optimizer adamw --scheduler cosine --criterion emotic_SL1 --cat-criterion ${cat_loss}"
...
do
    ...
    do
        if [ "$subj" == "$all_subjects" ]; then
            ...
            model_name="img_pretrained_lr_${lr}_subj_${subj}_datasetv1_1"
        fi
