...
CUDA_VISIBLE_DEVICES=${device} python3 main.py --exec_mode train --subj ${subj} \
 --wandb-name 0211_subject${subj}_reg_mlp_2 --model-name subject${subj}_reg_mlp_2 --wandb-project Brain2Valence --wandb-entity donghochoi \
...
CUDA_VISIBLE_DEVICES=${device} python3 main.py --exec_mode predict --subj ${subj} \
 --wandb-name 0211_subject${subj}_reg_mlp_2 --model-name subject${subj}_reg_mlp_2 --wandb-project Brain2Valence --wandb-entity donghochoi \
 --model mlp --task-type reg --data roi & wait
