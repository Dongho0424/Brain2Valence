    ...
    do
        ...
        do
            if [ "$subj" == "$all_subjects" ]; then
                model_name="vis_roi_scratch_lr_${lr}_subj_1257_bs_52_pn_${pn}_ep_50"
            else
                model_name="vis_roi_scratch_lr_${lr}_subj_${subj}_bs_52_pn_${pn}_ep_50"
            fi
...
do
    ...
    do
        ...
        do
            if [ "$subj" == "$all_subjects" ]; then
                model_name="vis_roi_scratch_lr_${lr}_subj_1257_bs_52_pn_${pn}_ep_50_"
            else
                model_name="vis_roi_scratch_lr_${lr}_subj_${subj}_bs_52_pn_${pn}_ep_50_"
            fi
...
do
    ...
    do
        ...
        do
            if [ "$subj" == "$all_subjects" ]; then
                model_name="emo_roi_scratch_lr_${lr}_subj_1257_bs_52_pn_${pn}_ep_50"
            else
                model_name="emo_roi_scratch_lr_${lr}_subj_${subj}_bs_52_pn_${pn}_ep_50"
            fi
...
do
    ...
    do
        ...
        do
            if [ "$subj" == "$all_subjects" ]; then
                model_name="emo_vis_roi_scratch_lr_${lr}_subj_1257_bs_52_pn_${pn}_ep_50"
            else
                model_name="emo_vis_roi_scratch_lr_${lr}_subj_${subj}_bs_52_pn_${pn}_ep_50"
            fi
...
for lr in 3e-4 5e-4 #5e-6 8e-6 1e-5 3e-5 5e-5 1e-4 
do
    for subj in 1 2 5 7 "$all_subjects"
    do
        if [ "$subj" == "$all_subjects" ]; then
