...
do
    ...
    do
        ...
        --wandb-log --model-name finetuning_roi_img_${lr}_wd${wd}_not_freeze --notes _0705_2 --group finetuning_roi_img --wandb-project fMRI_Emotion --wandb-entity donghochoi \
