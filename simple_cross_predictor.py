...
class SimpleCrossPredictor:
    ...
    def prepare_dataloader(self):
        ...
        self.subjects = self.args.subj_tgt
        print("Predicting for subjects:", self.subjects)
        
        self.test_dl, self.num_test = self.get_single_dl(self.subjects[0], 1, 'test')
    ...
    def load_model(self, args, use_best=True):
        ...
        if use_best:
            ...
            print("Predict with last epoch's weight model")
