...
CUDA_VISIBLE_DEVICES=3 python3 main.py --exec_mode train --wandb-name test --wandb-project Brain2Valence --wandb-entity donghochoi\
 --epochs 100 --batch-size 16 --lr 1e-4 --weight-decay 0.0001 --seed 42 --criterion mae 
